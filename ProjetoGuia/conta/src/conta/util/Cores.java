...
public class Cores {
	...
	public static final String TEXT_BLACK_BRIGHT = "\033[4;90m";
	public static final String TEXT_RED_BRIGHT  = "\033[4;91m";
	public static final String TEXT_GREEN_BRIGHT = "\033[4;92m";
	public static final String TEXT_YELLOW_BRIGHT = "\033[4;93m";
	public static final String TEXT_BLUE_BRIGHT = "\033[4;94m";
	public static final String TEXT_PURPLE_BRIGHT = "\033[4;95m";
	public static final String TEXT_CYAN_BRIGHT = "\033[4;96m";
	public static final String TEXT_WHITE_BRIGHT = "\033[4;97m";
	
	
	public static final String TEXT_BLACK_BOLD_BRIGHT = "\u001B[40m";
	public static final String TEXT_RED_BOLD_BRIGHT  = "\u001B[41m";
	public static final String TEXT_GREEN_BOLD_BRIGHT = "\u001B[42m";
	public static final String TEXT_YELLOW_BOLD_BRIGHT = "\u001B[43m";
	public static final String TEXT_BLUE_BOLD_BRIGHT = "\u001B[44m";
	public static final String TEXT_PURPLE_BOLD_BRIGHT = "\u001B[45m";
	public static final String TEXT_CYAN_BOLD_BRIGHT = "\u001B[46m";
	public static final String TEXT_WHITE_BOLD_BRIGHT = "\u001B[47m";
